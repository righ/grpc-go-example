...
```
$ go get -u github.com/righ/grpc-go-example/helloworld/greeter_client
$ go get -u github.com/righ/grpc-go-example/helloworld/greeter_server
```
...
1. Rebuild the generated Go code
   ...
   ```
   $ go generate github.com/righ/grpc-go-example/helloworld/...
   ```
